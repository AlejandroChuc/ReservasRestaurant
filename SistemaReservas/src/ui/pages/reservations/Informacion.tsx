...
export default function InformacionPage({ onNext, onBack }: InformacionPageProps) {
  ...
  const handleContinue = () => {
    ...
    updateReservationData({
      firstName,
      lastName,
      customerName: `${firstName} ${lastName}`, // Mantener compatibilidad
      email,
      roomNumber,
    })
  ...
  const isComplete = firstName && lastName && email && roomNumber
  ...
  return (
    ...
    >
      <div className="w-full max-w-4xl mx-auto">
        {/* Resumen de selección anterior - Mejorado */}
        <div className="mb-8 bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-xl rounded-2xl p-6 shadow-xl border border-white/20">
        ...
        <div className="bg-gradient-to-br from-white/10 via-white/5 to-white/10 backdrop-blur-xl rounded-3xl p-8 md:p-12 shadow-2xl border border-white/20">
